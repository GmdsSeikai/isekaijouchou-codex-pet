...
这是非官方的粉丝创作项目。代码、构建工具和文档采用 MIT License；贡献者有权授权的美术源素材及衍生图采用 CC BY-NC-SA 4.0，仅允许非商业使用并要求署名、相同方式共享。

原角色及相关设定、名称和标识的权利归其原权利人所有。详细范围见 `NOTICE`、`LICENSE` 和 `LICENSE-ASSETS`。因此，本仓库应表述为“代码开源、美术素材非商业共享”，不应将整个仓库笼统称为开源软件。
